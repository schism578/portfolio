...
const Future = () => {
    return (
        <div className={classes.Future}>
            <p>Getting into web development was both a big shift and a happy accident &mdash; one of those moments where 
            ...
            away, others take a few tries &mdash; but that's part of the process. I've learned to stay flexible, keep an 
            open mind, and accept that growth often means letting go of what worked yesterday to make room for 
